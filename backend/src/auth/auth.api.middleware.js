...
var AUTH_DATA_SYMBOL = Symbol('auth-data');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    session_id = header.substr('Bearer '.length);
                    return [4 /*yield*/, userAuthBLL.GetCustomerSession(session_id)];
                case 1:
                    session = _a.sent();
                    if (!session) {
